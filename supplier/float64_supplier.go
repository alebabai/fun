...
// ToSilentSupplier transforms SilentFloat64Supplier into SilentSupplier
func (ss SilentFloat64Supplier) ToSilentSupplier() SilentSupplier {
...
// ToMustSupplier transforms MustFloat64Supplier into MustSupplier
func (ms MustFloat64Supplier) ToMustSupplier() MustSupplier {
	return func() interface{} {
		return ms()
	}
}
